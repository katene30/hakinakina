        ...
        return (
            <div>
              ...
              <div className="row justify-content-center food-container">
                ...
                <div className={`food-pos ${this.state.fat ? 'visible' : 'invisible'}`}>
              ...
              <div className="row justify-content-center">
                ...
                <div className="food-container">
                  ...
                  <div className="food-pos text-right" id='milk'>
              ...
              <div className="row justify-content-center">
                ...
                <div className="food-container">
                  ...
                  <div className="food-pos text-right" id="vegetable">
                      <h4>Vegetables</h4>
                  ...
                  <div className="food-container">
                    ...
                    <div className="food-pos text-left" id="fruit">
                        <h4>Fruits</h4>
